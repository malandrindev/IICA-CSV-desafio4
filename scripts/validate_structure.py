...
REQUIRED_FILES = (
    ...
    "docs/relatorio_tecnico/relatorio.md",
    "data/dictionaries/dicionario_dados_202401.json",
    ...
    "src/iica_csv/config.py",
    "src/iica_csv/processing/csv_reader.py",
    "src/iica_csv/processing/data_manager.py",
    "src/iica_csv/processing/zip_processor.py",
    "src/iica_csv/tools/data_tools.py",
    "src/iica_csv/agents/csv_agent.py",
    "src/iica_csv/agents/groq_errors.py",
    "src/iica_csv/agents/semantic_resolver.py",
    "src/iica_csv/ui/app.py",
    "src/iica_csv/ui/rendering.py",
    "tests/test_csv_reader.py",
    "tests/test_zip_processor.py",
    "tests/test_data_tools.py",
    "tests/test_semantic_resolver.py",
    "tests/test_demo_dictionary_semantics.py",
    "tests/test_demo_package_regression.py",
    "tests/test_groq_errors.py",
)
